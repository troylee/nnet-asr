...
#define SVN_DATE       "$Date: 2009-09-24 23:44:48 +0800 (Thu, 24 Sep 2009) $"
#define SVN_AUTHOR     "$Author: ciprtom $"
#define SVN_REVISION   "$Revision: 291 $"
#define SVN_ID         "$Id: SFeaCat.cc 291 2009-09-24 15:44:48Z ciprtom $"
