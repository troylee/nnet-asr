...
#define SVN_DATE       "$Date: 2009-09-09 04:59:29 +0800 (Wed, 09 Sep 2009) $"
#define SVN_AUTHOR     "$Author: schwarzp $"
#define SVN_REVISION   "$Revision: 288 $"
#define SVN_ID         "$Id: SLRatio.cc 288 2009-09-08 20:59:29Z schwarzp $"
